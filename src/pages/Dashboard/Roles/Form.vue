       ...
       <div class="row">
          ...
          <l-button @click="volver()" type="default">
            ...
            Volver
             ...
             <button  v-if="tipoAccion == 1" type="submit" class="btn btn-success btn-fill pull-right">Guardar Rol</button>
             <button  v-else @click="enviarFormulario()" class="btn btn-info btn-fill pull-right">Actualizar Rol</button>
