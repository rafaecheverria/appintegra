  ...
  <div class="wrapper" :class="{'nav-open': $sidebar.showSidebar}">
    ...
    <side-bar>
      ...
      <template slot="links">
        ...
        <sidebar-item :link="{name: 'Charts', icon: 'nc-icon nc-chart-bar-32', path: '/charts'}"></sidebar-item>
        <sidebar-item :link="{name: 'Calendar', icon: 'nc-icon nc-single-copy-04', path: '/calendar'}"></sidebar-item>
        <sidebar-item :link="{name: 'Configuración', icon: 'nc-icon nc-puzzle-10'}">
